...
#define ELMT_CHAR(l, i) (l).buffer[i].buildingChar
#define ELMT_POINT(l, i) (l).buffer[i].buildingPoint
...
boolean isIdxDinValid(ListDin l, int i);
...
/* Search apakah ada elemen List l yang buildingChar-nya bernilai val */
...
/* Menghasilkan berapa banyak kemunculan char buldingChar val di l */
/* Jika l kosong menghasilkan 0 */
